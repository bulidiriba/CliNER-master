...
def main():
    ...
    train_txt_files = glob.glob(open('data/examples/ex_doc.txt'))
    train_con_files = glob.glob(open('data/examples/ex_doc.con'))
    ...
    train(training_list, open('models/foo.model'), 'i2b2', args.use_lstm, logfile=args.log, val = val_list, test = test_list)
